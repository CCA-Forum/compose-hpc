...
void handleSWAP(ofstream &cocciFptr, bool checkBlasCallType, string fname, string uPrefix, SgExprListExp* fArgs){
	...
	if(checkBlasCallType){
		...
		cocciStream << "+  "<<cublasCall<<"(n, "<<uPrefix<<"_X,incx,"<<uPrefix<<"_Y,incy);  \n\n";
