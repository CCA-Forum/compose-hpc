...
class GlueCodeGenerator(object):
    ...
    def generate_makefile(self):
        ...
        """
        self.makefile.generate(self.sidl_files)
    ...
    def generate_bindings(self, filename, sidl_ast, symbol_table, with_server):
        ...
        try:
            ...
            if self.server:
                self.makefile.generate_server(self.sidl_files, self.classes, self.pkgs,
                                              self.config.make_prefix)
            else:
                self.makefile.generate_client(self.sidl_files, self.classes,
                                              self.config.make_prefix)
