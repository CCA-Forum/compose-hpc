/*
 * File:          hpcc_HighPerformanceLinpack_IOR.c
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t hpcc_HighPerformanceLinpack__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &hpcc_HighPerformanceLinpack__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &hpcc_HighPerformanceLinpack__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &hpcc_HighPerformanceLinpack__mutex )==EDEADLOCK) */
#else
...
static struct hpcc_HighPerformanceLinpack__epv  
  s_my_epv__hpcc_highperformancelinpack;
static struct hpcc_HighPerformanceLinpack__sepv 
  s_stc_epv__hpcc_highperformancelinpack;

static struct hpcc_HighPerformanceLinpack__epv  
  s_my_epv_contracts__hpcc_highperformancelinpack;
static struct hpcc_HighPerformanceLinpack__sepv 
  s_stc_epv_contracts__hpcc_highperformancelinpack;

static struct hpcc_HighPerformanceLinpack__epv  
  s_my_epv_hooks__hpcc_highperformancelinpack;
static struct hpcc_HighPerformanceLinpack__sepv 
  s_stc_epv_hooks__hpcc_highperformancelinpack;
...
static struct hpcc_HighPerformanceLinpack__cstats s_cstats;

static struct hpcc_HighPerformanceLinpack__pre_epv s_preEPV;
static struct hpcc_HighPerformanceLinpack__post_epv s_postEPV;
static struct hpcc_HighPerformanceLinpack__pre_sepv s_preSEPV;
static struct hpcc_HighPerformanceLinpack__post_sepv s_postSEPV;
...
extern void hpcc_HighPerformanceLinpack__set_epv(
  struct hpcc_HighPerformanceLinpack__epv* epv,
    struct hpcc_HighPerformanceLinpack__pre_epv* pre_epv,
    struct hpcc_HighPerformanceLinpack__post_epv* post_epv);

extern void hpcc_HighPerformanceLinpack__set_sepv(
  struct hpcc_HighPerformanceLinpack__sepv* sepv,
    struct hpcc_HighPerformanceLinpack__pre_sepv* pre_sepv,
    struct hpcc_HighPerformanceLinpack__post_sepv* post_sepv);

extern void hpcc_HighPerformanceLinpack__call_load(void);
#ifdef __cplusplus
}
#endif

static void
hpcc_HighPerformanceLinpack_addRef__exec(
        struct hpcc_HighPerformanceLinpack__object* self,
...
static void
hpcc_HighPerformanceLinpack_deleteRef__exec(
        struct hpcc_HighPerformanceLinpack__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
hpcc_HighPerformanceLinpack_isSame__exec(
        struct hpcc_HighPerformanceLinpack__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_hpcc_HighPerformanceLinpack_fconnect_sidl_BaseInterface(iobj_str, 
    TRUE, _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct hpcc_HighPerformanceLinpack__object*) (
      *iobj_bc->d_epv->f__cast)(iobj_bc, "hpcc.HighPerformanceLinpack", _ex);
    if(iobj != NULL) {
...
static void
hpcc_HighPerformanceLinpack_isType__exec(
        struct hpcc_HighPerformanceLinpack__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
hpcc_HighPerformanceLinpack_getClassInfo__exec(
        struct hpcc_HighPerformanceLinpack__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
hpcc_HighPerformanceLinpack__cast__exec(
        struct hpcc_HighPerformanceLinpack__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_hpcc_HighPerformanceLinpack__set_contracts_static(
  sidl_bool   enable,
...
static void ior_hpcc_HighPerformanceLinpack__dump_stats_static(
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
{
...
static void ior_hpcc_HighPerformanceLinpack__set_contracts(
  struct hpcc_HighPerformanceLinpack__object* self,
  sidl_bool   enable,
  const char* enfFilename,
  sidl_bool   resetCounters,
...
static void ior_hpcc_HighPerformanceLinpack__dump_stats(
  struct hpcc_HighPerformanceLinpack__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_hpcc_HighPerformanceLinpack__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    hpcc_HighPerformanceLinpack__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_hpcc_HighPerformanceLinpack__cast(
  struct hpcc_HighPerformanceLinpack__object* self,
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    cmp = strcmp(name, "hpcc.HighPerformanceLinpack");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      cast = ((struct hpcc_HighPerformanceLinpack__object*)self);
      return cast;
    }
  }
  else if (cmp > 0) {
...
static void ior_hpcc_HighPerformanceLinpack__set_hooks_static(
...
static void ior_hpcc_HighPerformanceLinpack__set_hooks(
  struct hpcc_HighPerformanceLinpack__object* self,
  sidl_bool enable, struct sidl_BaseInterface__object **_ex )
{
  *_ex  = NULL;
...
static void ior_hpcc_HighPerformanceLinpack__delete(
  struct hpcc_HighPerformanceLinpack__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  hpcc_HighPerformanceLinpack__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct hpcc_HighPerformanceLinpack__object));
  free((void*) self);
}

static char*
ior_hpcc_HighPerformanceLinpack__getURL(
  struct hpcc_HighPerformanceLinpack__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_hpcc_HighPerformanceLinpack__raddRef(
    struct hpcc_HighPerformanceLinpack__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_hpcc_HighPerformanceLinpack__isRemote(
    struct hpcc_HighPerformanceLinpack__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct hpcc_HighPerformanceLinpack__method {
  const char *d_name;
  void (*d_func)(struct hpcc_HighPerformanceLinpack__object*,
...
static void
ior_hpcc_HighPerformanceLinpack__exec(
  struct hpcc_HighPerformanceLinpack__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct hpcc_HighPerformanceLinpack__method  s_methods[] = {
    { "_cast", hpcc_HighPerformanceLinpack__cast__exec },
    { "addRef", hpcc_HighPerformanceLinpack_addRef__exec },
    { "deleteRef", hpcc_HighPerformanceLinpack_deleteRef__exec },
    { "getClassInfo", hpcc_HighPerformanceLinpack_getClassInfo__exec },
    { "isSame", hpcc_HighPerformanceLinpack_isSame__exec },
    { "isType", hpcc_HighPerformanceLinpack_isType__exec },
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct hpcc_HighPerformanceLinpack__method);
  *_ex  = NULL; /* default to no exception */
...
static void hpcc_HighPerformanceLinpack__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct hpcc_HighPerformanceLinpack__epv*  epv  = &s_my_epv__hpcc_highperformancelinpack;
  ...
  epv->f__cast                 = ior_hpcc_HighPerformanceLinpack__cast;
  epv->f__delete               = ior_hpcc_HighPerformanceLinpack__delete;
  epv->f__exec                 = ior_hpcc_HighPerformanceLinpack__exec;
  epv->f__getURL               = ior_hpcc_HighPerformanceLinpack__getURL;
  epv->f__raddRef              = ior_hpcc_HighPerformanceLinpack__raddRef;
  epv->f__isRemote             = ior_hpcc_HighPerformanceLinpack__isRemote;
  epv->f__set_hooks            = ior_hpcc_HighPerformanceLinpack__set_hooks;
  epv->f__set_contracts        = ior_hpcc_HighPerformanceLinpack__set_contracts;
  epv->f__dump_stats           = ior_hpcc_HighPerformanceLinpack__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct hpcc_HighPerformanceLinpack__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct hpcc_HighPerformanceLinpack__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct hpcc_HighPerformanceLinpack__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct hpcc_HighPerformanceLinpack__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct hpcc_HighPerformanceLinpack__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;

  hpcc_HighPerformanceLinpack__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  ior_hpcc_HighPerformanceLinpack__ensure_load_called();
}
...
static void hpcc_HighPerformanceLinpack__init_sepv(void)
{
  /*
   * assert( HAVE_LOCKED_STATIC_GLOBALS );
   */
  ...
  struct hpcc_HighPerformanceLinpack__sepv*  s = &s_stc_epv__hpcc_highperformancelinpack;

  s->f__set_hooks_static                        = ior_hpcc_HighPerformanceLinpack__set_hooks_static;
  s->f__set_contracts_static                    = ior_hpcc_HighPerformanceLinpack__set_contracts_static;
  s->f__dump_stats_static                       = ior_hpcc_HighPerformanceLinpack__dump_stats_static;
  s->f_panelSolveCompute    = NULL;

  hpcc_HighPerformanceLinpack__set_sepv(s, &s_preSEPV, &s_postSEPV);

  ior_hpcc_HighPerformanceLinpack__set_hooks_static(FALSE, &throwaway_exception);
...
/*
 * hpcc_HighPerformanceLinpack__getEPVs: Get my version of all relevant EPVs.
 */

void hpcc_HighPerformanceLinpack__getEPVs (
  struct sidl_BaseInterface__epv **s_arg_epv__sidl_baseinterface,
  struct sidl_BaseClass__epv **s_arg_epv__sidl_baseclass,
  struct hpcc_HighPerformanceLinpack__epv **s_arg_epv__hpcc_highperformancelinpack,
  struct hpcc_HighPerformanceLinpack__epv **s_arg_epv_hooks__hpcc_highperformancelinpack)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    hpcc_HighPerformanceLinpack__init_epv();
  }
  UNLOCK_STATIC_GLOBALS;

  *s_arg_epv__sidl_baseinterface = &s_my_epv__sidl_baseinterface;
  *s_arg_epv__sidl_baseclass = &s_my_epv__sidl_baseclass;
  *s_arg_epv__hpcc_highperformancelinpack = &s_my_epv__hpcc_highperformancelinpack;
  *s_arg_epv_hooks__hpcc_highperformancelinpack = &s_my_epv_hooks__hpcc_highperformancelinpack;
}
/*
 * hpcc_HighPerformanceLinpack__getStaticEPV: return pointer to static EPV structure.
 */
...
hpcc_HighPerformanceLinpack__getStaticEPV(void){
  ...
  if (!s_static_initialized) {
    hpcc_HighPerformanceLinpack__init_sepv();
  }
  UNLOCK_STATIC_GLOBALS;
  return &s_stc_epv__hpcc_highperformancelinpack;
}
...
static struct sidl_BaseClass__epv* hpcc_HighPerformanceLinpack__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "hpcc.HighPerformanceLinpack", _ex);
...
static void
initMetadata(struct hpcc_HighPerformanceLinpack__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * hpcc_HighPerformanceLinpack__createObject: Allocate the object and initialize it.
 */

struct hpcc_HighPerformanceLinpack__object*
hpcc_HighPerformanceLinpack__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct hpcc_HighPerformanceLinpack__object* self =
    (struct hpcc_HighPerformanceLinpack__object*) sidl_malloc(
      sizeof(struct hpcc_HighPerformanceLinpack__object),
      "Object allocation failed for struct hpcc_HighPerformanceLinpack__object",
        __FILE__, __LINE__, "hpcc_HighPerformanceLinpack__createObject", _ex);
  if (!self) goto EXIT;
  hpcc_HighPerformanceLinpack__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void hpcc_HighPerformanceLinpack__init(
  struct hpcc_HighPerformanceLinpack__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct hpcc_HighPerformanceLinpack__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__hpcc_highperformancelinpack;
...
void hpcc_HighPerformanceLinpack__fini(
  struct hpcc_HighPerformanceLinpack__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct hpcc_HighPerformanceLinpack__object* s0 = self;
...
void
hpcc_HighPerformanceLinpack__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct hpcc_HighPerformanceLinpack__external
s_externalEntryPoints = {
  hpcc_HighPerformanceLinpack__createObject,
  hpcc_HighPerformanceLinpack__getStaticEPV,
  hpcc_HighPerformanceLinpack__getSuperEPV,
  2, 
  0
};
