/*
 * File:          hplsupport_SimpleArray1dInt_IOR.h
...
#define included_hplsupport_SimpleArray1dInt_IOR_h
...
struct hplsupport_SimpleArray1dInt__cstats {
  sidl_bool use_hooks;
};
...
hplsupport_SimpleArray1dInt__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void hplsupport_SimpleArray1dInt__init(
  struct hplsupport_SimpleArray1dInt__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void hplsupport_SimpleArray1dInt__getEPVs(
...
extern void hplsupport_SimpleArray1dInt__IOR_version(int32_t *major, int32_t 
  *minor);
