...
static struct blas_VectorUtils__cstats s_cstats;

static struct blas_VectorUtils__pre_epv s_preEPV;
static struct blas_VectorUtils__post_epv s_postEPV;
static struct blas_VectorUtils__pre_sepv s_preSEPV;
static struct blas_VectorUtils__post_sepv s_postSEPV;
...
extern void blas_VectorUtils__set_epv(
  struct blas_VectorUtils__epv* epv,
    struct blas_VectorUtils__pre_epv* pre_epv,
    struct blas_VectorUtils__post_epv* post_epv);

extern void blas_VectorUtils__set_sepv(
  struct blas_VectorUtils__sepv* sepv,
    struct blas_VectorUtils__pre_sepv* pre_sepv,
    struct blas_VectorUtils__post_sepv* post_sepv);

extern void blas_VectorUtils__call_load(void);
#ifdef __cplusplus
}
#endif

static void
blas_VectorUtils_addRef__exec(
...
static void
blas_VectorUtils_deleteRef__exec(
        struct blas_VectorUtils__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
blas_VectorUtils_isSame__exec(
  ...
  iobj = skel_blas_VectorUtils_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct blas_VectorUtils__object*) (*iobj_bc->d_epv->f__cast)(iobj_bc,
      "blas.VectorUtils", _ex);
    if(iobj != NULL) {
...
static void
blas_VectorUtils_getClassInfo__exec(
        struct blas_VectorUtils__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_blas_VectorUtils__set_contracts_static(
  sidl_bool   enable,
...
static void ior_blas_VectorUtils__dump_stats_static(
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
{
...
static void ior_blas_VectorUtils__set_contracts(
  struct blas_VectorUtils__object* self,
  sidl_bool   enable,
  const char* enfFilename,
  sidl_bool   resetCounters,
...
static void ior_blas_VectorUtils__dump_stats(
  struct blas_VectorUtils__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_blas_VectorUtils__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    blas_VectorUtils__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_blas_VectorUtils__cast(
  struct blas_VectorUtils__object* self,
...
static void ior_blas_VectorUtils__set_hooks_static(
...
static void ior_blas_VectorUtils__set_hooks(
  struct blas_VectorUtils__object* self,
  sidl_bool enable, struct sidl_BaseInterface__object **_ex )
{
  *_ex  = NULL;
...
static void ior_blas_VectorUtils__delete(
  struct blas_VectorUtils__object* self, struct sidl_BaseInterface__object 
    **_ex)
{
  *_ex  = NULL; /* default to no exception */
  blas_VectorUtils__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct blas_VectorUtils__object));
  free((void*) self);
}

static char*
ior_blas_VectorUtils__getURL(
  struct blas_VectorUtils__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_blas_VectorUtils__raddRef(
    struct blas_VectorUtils__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_blas_VectorUtils__isRemote(
    struct blas_VectorUtils__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct blas_VectorUtils__method {
  const char *d_name;
  void (*d_func)(struct blas_VectorUtils__object*,
...
ior_blas_VectorUtils__exec(
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct blas_VectorUtils__method  s_methods[] = {
    { "_cast", blas_VectorUtils__cast__exec },
    { "addRef", blas_VectorUtils_addRef__exec },
    { "deleteRef", blas_VectorUtils_deleteRef__exec },
    { "getClassInfo", blas_VectorUtils_getClassInfo__exec },
    { "isSame", blas_VectorUtils_isSame__exec },
    { "isType", blas_VectorUtils_isType__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct blas_VectorUtils__method);
  *_ex  = NULL; /* default to no exception */
...
static void blas_VectorUtils__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct blas_VectorUtils__epv*   epv  = &s_my_epv__blas_vectorutils;
  ...
  epv->f__cast                 = ior_blas_VectorUtils__cast;
  epv->f__delete               = ior_blas_VectorUtils__delete;
  epv->f__exec                 = ior_blas_VectorUtils__exec;
  epv->f__getURL               = ior_blas_VectorUtils__getURL;
  epv->f__raddRef              = ior_blas_VectorUtils__raddRef;
  epv->f__isRemote             = ior_blas_VectorUtils__isRemote;
  epv->f__set_hooks            = ior_blas_VectorUtils__set_hooks;
  epv->f__set_contracts        = ior_blas_VectorUtils__set_contracts;
  epv->f__dump_stats           = ior_blas_VectorUtils__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct blas_VectorUtils__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct blas_VectorUtils__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct blas_VectorUtils__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct blas_VectorUtils__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct blas_VectorUtils__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;

  blas_VectorUtils__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  ior_blas_VectorUtils__ensure_load_called();
}
...
static void blas_VectorUtils__init_sepv(void)
{
  /*
   * assert( HAVE_LOCKED_STATIC_GLOBALS );
   */
  ...
  struct blas_VectorUtils__sepv*  s = &s_stc_epv__blas_vectorutils;

  s->f__set_hooks_static             = ior_blas_VectorUtils__set_hooks_static;
  s->f__set_contracts_static         = ior_blas_VectorUtils__set_contracts_static;
  s->f__dump_stats_static            = ior_blas_VectorUtils__dump_stats_static;
  s->f_helper_daxpy    = NULL;

  blas_VectorUtils__set_sepv(s, &s_preSEPV, &s_postSEPV);

  ior_blas_VectorUtils__set_hooks_static(FALSE, &throwaway_exception);
...
/*
 * blas_VectorUtils__getEPVs: Get my version of all relevant EPVs.
 */

void blas_VectorUtils__getEPVs (
  ...
  struct blas_VectorUtils__epv **s_arg_epv_hooks__blas_vectorutils)
{
  ...
  if (!s_method_initialized) {
    blas_VectorUtils__init_epv();
  }
  UNLOCK_STATIC_GLOBALS;

  *s_arg_epv__sidl_baseinterface = &s_my_epv__sidl_baseinterface;
  *s_arg_epv__sidl_baseclass = &s_my_epv__sidl_baseclass;
  *s_arg_epv__blas_vectorutils = &s_my_epv__blas_vectorutils;
  *s_arg_epv_hooks__blas_vectorutils = &s_my_epv_hooks__blas_vectorutils;
}
/*
 * blas_VectorUtils__getStaticEPV: return pointer to static EPV structure.
 */
...
blas_VectorUtils__getStaticEPV(void){
  ...
  if (!s_static_initialized) {
    blas_VectorUtils__init_sepv();
  }
  UNLOCK_STATIC_GLOBALS;
  return &s_stc_epv__blas_vectorutils;
}
...
static struct sidl_BaseClass__epv* blas_VectorUtils__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "blas.VectorUtils", _ex);
...
static void
initMetadata(struct blas_VectorUtils__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * blas_VectorUtils__createObject: Allocate the object and initialize it.
 */

struct blas_VectorUtils__object*
blas_VectorUtils__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct blas_VectorUtils__object* self =
    (struct blas_VectorUtils__object*) sidl_malloc(
      sizeof(struct blas_VectorUtils__object),
      "Object allocation failed for struct blas_VectorUtils__object",
        __FILE__, __LINE__, "blas_VectorUtils__createObject", _ex);
  if (!self) goto EXIT;
  blas_VectorUtils__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void blas_VectorUtils__init(
  struct blas_VectorUtils__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct blas_VectorUtils__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__blas_vectorutils;
...
void
blas_VectorUtils__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct blas_VectorUtils__external
s_externalEntryPoints = {
  blas_VectorUtils__createObject,
  blas_VectorUtils__getStaticEPV,
  blas_VectorUtils__getSuperEPV,
  2, 
  0
};
