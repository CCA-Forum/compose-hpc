...
struct blas_VectorUtils__epv {
  ...
  void (*f__exec)( struct blas_VectorUtils__object* self, const char* methodName, 
    void* FIXMEinArgs, void* FIXMEoutArgs, struct sidl_BaseInterface__object** 
    _ex);
  ...
  void (*f__dump_stats)( struct blas_VectorUtils__object* self, const char* 
    filename, const char* prefix, struct sidl_BaseInterface__object** _ex);
  ...
  int (*f_isSame)( struct blas_VectorUtils__object* self, struct 
    sidl_BaseInterface__object* iobj, struct sidl_BaseInterface__object** _ex);
  int (*f_isType)( struct blas_VectorUtils__object* self, const char* type, 
    struct sidl_BaseInterface__object** _ex);
  struct sidl_ClassInfo__object* (*f_getClassInfo)( struct 
    blas_VectorUtils__object* self, struct sidl_BaseInterface__object** _ex);
};

struct blas_VectorUtils__sepv {
  void (*f_setHooks_static)( int enable, struct sidl_BaseInterface__object** 
    _ex);
  void (*f_set_contracts_static)( int enable, const char* enfFilename, int 
    resetCounters, struct sidl_BaseInterface__object** _ex);
  ...
  void (*f_helper_daxpy)( int n, double alpha, sidl_double__array X, 
    sidl_double__array Y, struct sidl_BaseInterface__object** _ex);
};

/**
 * INIT: initialize a new instance of the class object.
 */
void blas_VectorUtils__init( struct blas_VectorUtils__object* self, void* data, struct sidl_BaseInterface__object** _ex);
/**
 * FINI: deallocate a class instance (destructor).
 */
void blas_VectorUtils__fini( struct blas_VectorUtils__object* self, struct sidl_BaseInterface__object** _ex);
