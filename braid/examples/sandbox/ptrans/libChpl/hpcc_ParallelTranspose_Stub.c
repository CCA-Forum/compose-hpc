/*
 * File:          hpcc_ParallelTranspose_Stub.c
...
#define HPCC_PARALLELTRANSPOSE_INLINE_DECL
...
static const struct hpcc_ParallelTranspose__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct hpcc_ParallelTranspose__external* _loadIOR(void)
/*
...

{
  ...
  _externals = hpcc_ParallelTranspose__externals();
#else
  _externals = (struct hpcc_ParallelTranspose__external*)sidl_dynamicLoadIOR(
    "hpcc.ParallelTranspose","hpcc_ParallelTranspose__externals") ;
  sidl_checkIORVersion("hpcc.ParallelTranspose", 
...
static hpcc_ParallelTranspose hpcc_ParallelTranspose__remoteCreate(const char* 
...
{
  return hpcc_ParallelTranspose__remoteCreate(url, _ex);
}
...
hpcc_ParallelTranspose
hpcc_ParallelTranspose__connect(const char* url, sidl_BaseInterface *_ex)
{
  return hpcc_ParallelTranspose__remoteConnect(url, TRUE, _ex);
}
...
hpcc_ParallelTranspose__cast(
  ...
  sidl_BaseInterface* _ex)
{
  hpcc_ParallelTranspose cast = NULL;
  ...
  if (!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("hpcc.ParallelTranspose", (
      void*)hpcc_ParallelTranspose__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
#endif /*WITH_RMI*/
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (hpcc_ParallelTranspose) (*base->d_epv->f__cast)(
      base->d_object,
      "hpcc.ParallelTranspose", _ex); SIDL_CHECK(*_ex);
  }
...
hpcc_ParallelTranspose__isLocal(
  ...
  /* out */ sidl_BaseInterface *_ex)
{
  return !hpcc_ParallelTranspose__isRemote(self, _ex);
}
...
hpcc_ParallelTranspose__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct hpcc_ParallelTranspose__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
...
hpcc_ParallelTranspose__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct hpcc_ParallelTranspose__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
...
{
  return (struct hpcc_ParallelTranspose__array*)sidl_interface__array_create1d(
    len);
}
...
{
  return (struct 
    hpcc_ParallelTranspose__array*)sidl_interface__array_create1dInit(len, (
...
{
  return (struct 
    hpcc_ParallelTranspose__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct 
    hpcc_ParallelTranspose__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct hpcc_ParallelTranspose__array*)sidl_interface__array_borrow(
...
{
  return (struct hpcc_ParallelTranspose__array*)
