#include <pgas.h>
#include <pgas_blockedDoubleArray_cStub.h>
/**
 * 
...
struct sidl_ClassInfo__object* pgas_blockedDoubleArray_getClassInfo_stub( struct pgas_blockedDoubleArray__object* self, struct sidl_BaseInterface__object** _ex) {
