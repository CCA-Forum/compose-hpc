...
void handleHSPMV(ofstream &cocciFptr, bool checkBlasCallType, bool isRowMajor,
    ...
    if (checkBlasCallType)
        cocciStream << "- " << blasCall << "(order,uplo, n, alpha," << matARef
                << "," << vecXRef << ",incx,beta," << vecYRef << ",incy); \n";
    else
    ...
    if (checkBlasCallType) {
        ...
        cocciStream << "+  " << cublasCall << "(" << uplo << ",n, alpha,"
                << uPrefix << "_A," << uPrefix << "_X,incx,beta," << uPrefix
                << "_Y,incy);  \n\n";
        ...
        cocciStream << "+  /* CUBLAS call */  \n";
        cocciStream << "+  " << cublasCall << "(*(uplo),*(n), *(alpha),"
                << uPrefix << "_A," << uPrefix << "_X,*(incx),*(beta),"
                << uPrefix << "_Y,*(incy));  \n\n";
        cocciStream << "+  /* Copy result vector back to host */  \n";
        cocciStream << "+  cublasSetVector ( *(n), sizeType_" << uPrefix << ","
                << uPrefix << "_Y, *(incy), " << vecYRef << ", *(incy));  \n";
