...
typedef int bool;
int nbfn, ichunk, g_counter, icut1, icut2, icut3, icut4, g_fock, newtask,
        maxnbfn, g_schwarz, g_dens, tol2e;
...
int translate_task(long int itask, int *lo, int *hi, int *ilo, int *jlo,
        int *klo, int *llo) {
    long int imax;
    int itmp;
    int ret;
